...
- `examples/meta-chat-template.json` – meta-chat aggregation logic stub.

These are samples, not production-ready. Adjust prompts, metadata, and JS logic to your needs.
